...
require (
	github.com/tmc/cc v0.0.0-00010101000000-000000000000
	...
	github.com/tmc/swiftui v0.0.0-00010101000000-000000000000
)
...
replace github.com/tmc/mlx-go/examples/mlx-go-ccl => ../mlx-go-examples/mlx-go-ccl

replace github.com/tmc/cc => ../cc

replace github.com/tmc/swiftui => ../swiftui
